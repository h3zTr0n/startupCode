...
class Location(models.Model):
    province = models.CharField(("Province"), max_length=200, null=True, blank=True)
...
class Manufacturer(models.Model):
    ...
    # email = models.EmailField(("Seller Email"), null=True, blank=True)
...
class Product(models.Model):
    ...
    is_free_shipping = models.BooleanField(
        default=False, help_text='No Delivery charges')
